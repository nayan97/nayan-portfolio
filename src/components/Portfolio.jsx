...
const projects = [
  {
    id: 1,
    name: "Go Bangla - Trip Planner App",
    image:
    ...
    description:
     ...
     live: "https://gobangla-fc335.web.app/",
    githubClient: "https://github.com/nayan97/go-bangla",
    challenges:
  ...
  {
    id: 2,
    name: "Devs Academy - LMS Platform",
    image:
    ...
    live: "https://github.com/nayan97/devs-acadamy",
    githubClient: "https://career-corner-bd.web.app/",
    challenges:
  ...
  },
  {
    ...
    tech:
    ["Laravel", "MySQL", "REST api", "Bootstrap", "Stripe"],
    description:
    ...
    live: "https://github.com/nayan97/techmart",
    githubClient: "https://github.com/nayan97/techmart",
    challenges:
...
const Portfolio = () => {
  ...
  return (
   <div className="bg-[#112e42] text-white">
     <section className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {projects.map((p) => (
          <article key={p.id} className="bg-[#081b29] rounded-2xl shadow-md overflow-hidden flex flex-col">
            ...
            <div className="p-4 flex-1 flex flex-col">
              ...
              <ul className="flex flex-wrap gap-2 mb-4">
                {p.tech.slice(0, 3).map((t) => (
                  <li key={t} className="text-xs px-2 py-1 bg-[#112e42] rounded-md">{t}</li>
                ))}
                {p.tech.length > 3 && (
                  <li className="text-xs px-2 py-1 bg-[#112e42] rounded-md">+{p.tech.length - 3}</li>
                )}
              </ul>
              ...
              <div className="mt-auto flex items-center justify-between">
                <button
                  onClick={() => setActive(p)}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full font-semibold bg-green-400 text-white hover:bg-green-300"
                ...
                <a
                  ...
                  className="btn btn-outline rounded-4xl p-6"
                >
                 View Live
                </a>
              </div>
              ...
              <div className="space-y-4 text-gray-800">
                ...
                <div className="pt-4 flex items-center gap-3">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-4 py-2 rounded-lg font-semibold bg-green-400  text-white"
                  >
                    Visit Live
                  </a>
