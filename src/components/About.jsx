...
const About = () => {
  return (
    ...
    <section id="about" className="py-16 bg-[#081b29] text-white">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8">About Me</h2>
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-10 px-6">
        
        {/* Left: Profile Image */}
        <div className="flex justify-center">
          <div className="relative">
            <div className="absolute -inset-2 rounded-full border-4 border-transparent bg-gradient-to-r from-green-400 to-green-700 animate-spin-slow"></div>
            <img
              src="https://i.ibb.co/B2Qz7wM5/hero-img.png"
              alt="Profile"
              className="relative rounded-full w-80 h-80 object- border-4 border-transparent p-2"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <h2 className="text-4xl font-bold mb-4">
            Who is <span className="text-green-400">Nayan Islam</span>?
          </h2>
          <p className="text-xl font-medium mb-4">
            Helping businesses grow with innovative web development and creative digital solutions.
          </p>
          <p className="text-gray-300 mb-6">
            Hi, I'm Nayan Islam, a passionate Full-Stack Developer who thrives on building high-performing,
